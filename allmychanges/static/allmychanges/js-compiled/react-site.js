...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(175).render();
	__webpack_require__(176).render();
	__webpack_require__(178).render();
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	    render: function render() {
	        ...
	        if (element !== null) {
	            React.render(React.createElement(PackageSelector, { url: '/v1/landing-package-suggest/?limit=1&versions_limit=5' }), element);
	        }
	    }
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Package = __webpack_require__(159);
	var metrika = __webpack_require__(161);
	...
	module.exports = React.createClass({
	    ...
	    load_package: function load_package() {
	        $.ajax({
	            url: this.props.url,
	            dataType: 'json',
	    ...
	    render: function render() {
	        ...
	        var tracked = _.map(this.state.tracked, function (changelog) {
	        ...
	        if (username == '') {
	            login_msg = React.createElement(
	                'p',
	                null,
	                'To see full release notes and to receive notifications on future updates, please, ',
	                React.createElement('br', null),
	                'login with ',
	                React.createElement(
	                    'a',
	                    { className: 'button _green _large', href: '/login/github/', id: 'package-selector__login-button-id' },
	                ...
	                React.createElement(
	                    'a',
	                    { className: 'button _blue _large', href: '/login/twitter/' },
	        ...
	        if (tracked.length > 0) {
	            tracked_msg = React.createElement(
	                'div',
	                { className: 'package-selector__tracked-msg' },
	                React.createElement(
	                    'p',
	                    null,
	                    'You\'ve followed these packages:'
	                ),
	                React.createElement(
	                    'ul',
	                    null,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SkipButton = __webpack_require__(162);
	...
	module.exports = React.createClass({
	  ...
	  render: function render() {
	    ...
	    return React.createElement(
	      'div',
	      { className: 'package-selector__package' },
	      React.createElement(
	        'h1',
	        { className: 'package-selector__title' },
	        React.createElement(
	          'a',
	          { href: url },
	      ...
	      React.createElement(
	        'h2',
	        { className: 'package-selector__description' },
	        this.props.description
	      ),
	      React.createElement(
	        'div',
	        { className: 'package-selector__versions-wrapper' },
	      ...
	      React.createElement(
	        'div',
	        { className: 'package-selector__buttons' },
	    ...
	    render: function render() {
	        ...
	        if (this.state.show_popup) {
	            popup = React.createElement(
	                'div',
	                { className: 'modal-popup', onClick: this.handle_popup_click },
	                React.createElement(
	                    'div',
	                    { className: 'modal-popup__content modal-popup__please-login' },
	                    React.createElement(
	                        'p',
	                        null,
	                        'Good job! You have made the first step, tracking this package.'
	                    ),
	                    React.createElement(
	                        'p',
	                        null,
	                    ...
	                    React.createElement(
	                        ...
	                        React.createElement(
	                            'a',
	                            { className: 'button _good _large', href: '/login/twitter/' },
	                            React.createElement('i', { className: 'fa fa-twitter fa-lg' }),
	                            ' Twitter'
	                        ),
	                        ' or ',
	                        React.createElement(
	                            'a',
	                            { className: 'button _good _large', href: '/login/github/' },
	                            React.createElement('i', { className: 'fa fa-github fa-lg' }),
	                            ' GitHub'
	                        )
	                    )
	        ...
	        if (this.state.tracked) {
	            return React.createElement(
	                ...
	                React.createElement(
	                    'button',
	                    { className: 'button _bad',
	                        onClick: this.untrack,
	                        title: 'Click to unsubscribe from this package.' },
	                    'Unfollow'
	                ),
	                popup
	            );
	    ...
	    render: function render() {
	        return React.createElement(
	            ...
	            React.createElement(
	                ...
	                { className: 'button',
	                    onClick: this.skip,
	                    title: 'Click me to show next package.' },
	                'Show next'
	            )
	        );
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var PackageSettings = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"../components/package-settings.js\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));

	/* make introjs globally available */
	window.intro = __webpack_require__(173);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = React.createClass({
	    ...
	    handle_form_keypress: function handle_form_keypress(e) {
	    ...
	    render: function render() {
	        ...
	        if (this.state.show_popup) {
	            popup = React.createElement(
	                'div',
	                { className: 'report-button__popup', onClick: this.handle_popup_click },
	                React.createElement(
	                    'form',
	                    ...
	                    React.createElement(
	                        'select',
	                        { className: 'select-box', ref: 'type', placeholder: 'Some issue type' },
	                        React.createElement(
	                            'option',
	                            { value: 'other' },
	                            '---'
	                        ...
	                        React.createElement(
	                            ...
	                            'Some version is missing'
	                        ),
	                        React.createElement(
	                            'option',
	                            { value: 'wrong-version' },
	                            'I found version which is wrong'
	                        ),
	                        React.createElement(
	                            'option',
	                            { value: 'wrong-dates' },
	                            'There is some problem with dates'
	                        ),
	                        React.createElement(
	                            'option',
	                            { value: 'wrong-version-content' },
	                            'A problem with content parsing'
	                        ),
	                        React.createElement(
	                            'option',
	                            { value: 'other' },
	        ...
	        return React.createElement(
	            'div',
	            { className: 'report-button__dropdown' },
	            React.createElement(
	                'button',
	                { className: 'button', onClick: this.handle_switcher_click, title: 'If you found some issues with this changelog, please file this issue.' },
	                React.createElement('i', { className: 'fa fa-exclamation-circle fa-lg', style: { color: '#D9534F', marginRight: '5px' } }),
	                'Report'
	            ),
	            popup
	        );
	...
	module.exports = React.createClass({
	    ...
	    render: function render() {
	        if (this.state.resolved) {
	            ...
	            return React.createElement(
	                'button',
	                { className: 'button', onClick: this.handle_click },
	                'Resolve'
	            );
	        }
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = React.createClass({
	    ...
	    componentDidMount: function componentDidMount() {
	        ...
	        var fetch_timer;
	        var fetch_suggestions = function fetch_suggestions(query, cb) {
	            clearTimeout(fetch_timer);
	            fetch_timer = setTimeout(function () {
	                really_fetch_suggestions(query, cb);
	            }, 500);
	        };
	        var really_fetch_suggestions = function really_fetch_suggestions(query, cb) {
	        ...
	        var show_suggestion = function show_suggestion(obj) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = React.createClass({
	  ...
	  render: function render() {
	    ...
	    var get_content = function get_content(tab) {
	      var snippets = {
	      ...
	      React.createElement(
	        ...
	        React.createElement(
	          ...
	          React.createElement(
	            ...
	            React.createElement(
	              'ul',
	              { className: 'share-badge__tabs' },
	              React.createElement(
	                'li',
	                { className: "tab " + tab_classes.markdown, onClick: this.show('markdown') },
	                'markdown'
	              ),
	              React.createElement(
	                'li',
	                { className: "tab " + tab_classes.rst, onClick: this.show('rst') },
	                'reST'
	              ),
	              React.createElement(
	                'li',
	                { className: "tab " + tab_classes.html, onClick: this.show('html') },
	                'html'
	              )
	            )
	          )
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = React.createClass({
	    ...
	    handle_comment_change: function handle_comment_change(e) {
	        this.setState({
	                ...
	                React.createElement(
	                    ...
	                    React.createElement(
	                        ...
	                        React.createElement(
	                            'button',
	                            { className: 'button _good',
	                                disabled: this.state.enable_submit ? false : "disabled" },
	                            'Send'
	                        )
	                    )
	                )
...
/***/ function(module, exports, __webpack_require__) {
	...
	var PriorityQueue = __webpack_require__(174);
	...
	*/
	...
	module.exports = {
	    push: function push(item, priority) {
	...
	module.exports = {
	    render: function render() {
	        $('.share-badge-container').each(function (idx, element) {
	            React.render(React.createElement(Share, { namespace: element.dataset['namespace'],
	                name: element.dataset['name'] }), element);
	        });
	    }
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Promo = __webpack_require__(177);
	...
	module.exports = React.createClass({
	    ...
	    componentDidMount: function componentDidMount() {
	        ...
	        var fetch_new_digest = (function (ids) {
	            ...
	            $.get('/landing-digest/?long-period=yes&changelogs=' + ids.join(',')).success((function (data) {
	                data = data.trim();
	                ...
	                if (data) {
	                    ...
	                    repeat_fetch_timer = setTimeout(fetch_new_digest, 1000, ids);
	                }
	            }).bind(this));
	        }).bind(this);
	        ...
	        $(element).on('typeahead:selected', (function (jquery, option) {
	            ...
	            var track = function track(resource_uri) {
	    ...
	    render: function render() {
	        var process_app = function process_app(obj) {
	            var icon = '';
	            ...
	            return React.createElement(
	                'li',
	                { key: obj.source, className: 'ios-promo__selected-app' },
	                React.createElement('img', { className: 'ios-promo__thumb', src: icon, title: obj.name })
	            );
	        };
	        ...
	        if (this.state.selected_apps.length > 0) {
	            if (this.state.digest_loaded) {
	                login_link = React.createElement(
	                    'div',
	                    { className: 'ios-promo__login' },
	                    React.createElement(
	                        'p',
	                        { className: 'ios-promo__text' },
	                        'Good job! Now, please, login with ',
	                        React.createElement(
	                            'a',
	                            { className: 'button _good _large', href: '/login/twitter/' },
	                            React.createElement('i', { className: 'fa fa-twitter fa-lg' }),
	            ...
	            login_link = React.createElement(
	                ...
	                React.createElement(
	                    ...
	                    React.createElement(
	                        'span',
	                        { className: 'ios-promo__highlight' },
	        ...
	        return React.createElement(
	            ...
	            React.createElement(
	                'div',
	                { className: 'ios-promo__input-wrapper' },
	                React.createElement('input', { type: 'search', name: 'q', ref: 'input',
	                    className: 'ios-promo__input',
	                    placeholder: 'Search iOS apps and add them to the list' }),
	                React.createElement('div', { className: 'input-spin-wrapper' }),
	                React.createElement(
	                    'ul',
	                    { className: 'ios-promo__selected-apps' },
	                    selected_apps
	                )
	            ),
	            login_link,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Landing = __webpack_require__(179);
