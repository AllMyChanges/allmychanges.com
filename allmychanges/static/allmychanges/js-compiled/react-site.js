...
/***/ function(module, exports, __webpack_require__) {
	...
	TrackButton = __webpack_require__(160)
	SkipButton = __webpack_require__(162)
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = React.createClass({displayName: "exports",
	    perform_action: function(action) {        UserStory.log(["performing action [action=", action, "]"], ["buttons.skip"]);
	        $.ajax({
	            url: '/v1/changelogs/' + this.props.changelog_id + '/' + action + '/',
	            method: 'POST',
	            dataType: 'json',
	    ...
	    render: function() {
	        ...
	        if (status == 'processing') {
	            ...
	            var is_parser_options_should_be_applied = function () {
	                ...
	                UserStory.log(["PARSER OPTIONS NEED APPLY? [result=", result, "]"], ["debug"]);
	                return result;
	            }.bind(this)
