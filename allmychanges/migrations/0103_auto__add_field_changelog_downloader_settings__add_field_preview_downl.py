...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Changelog.downloader_settings'
        db.add_column(u'allmychanges_changelog', 'downloader_settings',
                      self.gf('jsonfield.fields.JSONField')(default={}, blank=True),
                      keep_default=False)

        # Adding field 'Preview.downloader_settings'
        db.add_column(u'allmychanges_preview', 'downloader_settings',
                      self.gf('jsonfield.fields.JSONField')(default={}, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Changelog.downloader_settings'
        db.delete_column(u'allmychanges_changelog', 'downloader_settings')

        # Deleting field 'Preview.downloader_settings'
        db.delete_column(u'allmychanges_preview', 'downloader_settings')
    ...
    models = {
        ...
        u'allmychanges.changelog': {
            ...
            'downloader_settings': ('jsonfield.fields.JSONField', [], {'default': '{}', 'blank': 'True'}),
            'downloaders': ('jsonfield.fields.JSONField', [], {'default': '[]', 'blank': 'True'}),
        ...
        u'allmychanges.preview': {
            ...
            'downloader': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'downloader_settings': ('jsonfield.fields.JSONField', [], {'default': '{}', 'blank': 'True'}),
            'downloaders': ('jsonfield.fields.JSONField', [], {'default': '[]', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'ignore_list': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '1000', 'blank': 'True'}),
