...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'AutocompleteData'
        db.create_table(u'allmychanges_autocompletedata', (
            ...
            ('changelog', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='autocomplete', null=True, to=orm['allmychanges.Changelog'])),
        ))
        db.send_create_signal(u'allmychanges', ['AutocompleteData'])

        # Adding model 'AutocompleteWord'
        db.create_table(u'allmychanges_autocompleteword', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('word', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('data', self.gf('django.db.models.fields.related.ForeignKey')(related_name='words', to=orm['allmychanges.AutocompleteData'])),
        ))
        db.send_create_signal(u'allmychanges', ['AutocompleteWord'])


    def backwards(self, orm):
        # Deleting model 'AutocompleteData'
        db.delete_table(u'allmychanges_autocompletedata')

        # Deleting model 'AutocompleteWord'
        db.delete_table(u'allmychanges_autocompleteword')
