...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Package.user'
        db.alter_column(u'allmychanges_package', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['allmychanges.User']))

    def backwards(self, orm):

        # Changing field 'Package.user'
        db.alter_column(u'allmychanges_package', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))
