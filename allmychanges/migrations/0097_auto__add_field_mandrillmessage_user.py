...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MandrillMessage.user'
        db.add_column(u'allmychanges_mandrillmessage', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='mandrill_messages', null=True, on_delete=models.SET_NULL, to=orm['allmychanges.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MandrillMessage.user'
        db.delete_column(u'allmychanges_mandrillmessage', 'user_id')
