...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'AutocompleteData.source'
        db.alter_column(u'allmychanges_autocompletedata', 'source', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

    def backwards(self, orm):

        # Changing field 'AutocompleteData.source'
        db.alter_column(u'allmychanges_autocompletedata', 'source', self.gf('django.db.models.fields.CharField')(max_length=1000, null=True))
