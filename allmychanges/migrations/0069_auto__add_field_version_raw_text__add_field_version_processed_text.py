...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Version.raw_text'
        db.add_column(u'allmychanges_version', 'raw_text',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Version.processed_text'
        db.add_column(u'allmychanges_version', 'processed_text',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Version.raw_text'
        db.delete_column(u'allmychanges_version', 'raw_text')

        # Deleting field 'Version.processed_text'
        db.delete_column(u'allmychanges_version', 'processed_text')
