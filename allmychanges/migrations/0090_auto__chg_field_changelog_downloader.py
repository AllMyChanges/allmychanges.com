...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Changelog.downloader'
        db.alter_column(u'allmychanges_changelog', 'downloader', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))

    def backwards(self, orm):

        # Changing field 'Changelog.downloader'
        db.alter_column(u'allmychanges_changelog', 'downloader', self.gf('django.db.models.fields.CharField')(max_length=10, null=True))
