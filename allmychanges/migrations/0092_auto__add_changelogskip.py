...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ChangelogSkip'
        db.create_table(u'allmychanges_changelogskip', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='skips_changelogs', to=orm['allmychanges.User'])),
            ('changelog', self.gf('django.db.models.fields.related.ForeignKey')(related_name='skipped_by_users', to=orm['allmychanges.Changelog'])),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
        ))
        db.send_create_signal(u'allmychanges', ['ChangelogSkip'])


    def backwards(self, orm):
        # Deleting model 'ChangelogSkip'
        db.delete_table(u'allmychanges_changelogskip')
    ...
    models = {
        ...
        u'allmychanges.changelogskip': {
            ...
            'changelog': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'skipped_by_users'", 'to': u"orm['allmychanges.Changelog']"}),
            'created_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'skips_changelogs'", 'to': u"orm['allmychanges.User']"})
        },
