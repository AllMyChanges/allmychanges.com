...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Issue.user'
        db.add_column(u'allmychanges_issue', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['allmychanges.User'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Issue.light_user'
        db.add_column(u'allmychanges_issue', 'light_user',
                      self.gf('django.db.models.fields.CharField')(max_length=40, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Issue.user'
        db.delete_column(u'allmychanges_issue', 'user_id')

        # Deleting field 'Issue.light_user'
        db.delete_column(u'allmychanges_issue', 'light_user')
