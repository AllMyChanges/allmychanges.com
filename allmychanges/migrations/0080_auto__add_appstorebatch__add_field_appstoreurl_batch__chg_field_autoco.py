...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'AppStoreBatch'
        db.create_table(u'allmychanges_appstorebatch', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'allmychanges', ['AppStoreBatch'])

        # Adding field 'AppStoreUrl.batch'
        db.add_column(u'allmychanges_appstoreurl', 'batch',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='urls', null=True, on_delete=models.SET_NULL, to=orm['allmychanges.AppStoreBatch']),
                      keep_default=False)


        # Changing field 'AutocompleteData.title'
        db.alter_column(u'allmychanges_autocompletedata', 'title', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'AutocompleteData.icon'
        db.alter_column(u'allmychanges_autocompletedata', 'icon', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

    def backwards(self, orm):
        # Deleting model 'AppStoreBatch'
        db.delete_table(u'allmychanges_appstorebatch')

        # Deleting field 'AppStoreUrl.batch'
        db.delete_column(u'allmychanges_appstoreurl', 'batch_id')


        # Changing field 'AutocompleteData.title'
        db.alter_column(u'allmychanges_autocompletedata', 'title', self.gf('django.db.models.fields.CharField')(max_length=1000))

        # Changing field 'AutocompleteData.icon'
        db.alter_column(u'allmychanges_autocompletedata', 'icon', self.gf('django.db.models.fields.CharField')(max_length=1000, null=True))
