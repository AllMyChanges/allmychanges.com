...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Changelog.status'
        db.add_column(u'allmychanges_changelog', 'status',
                      self.gf('django.db.models.fields.CharField')(default='created', max_length=40),
                      keep_default=False)

        # Adding field 'Changelog.processing_status'
        db.add_column(u'allmychanges_changelog', 'processing_status',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=40),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Changelog.status'
        db.delete_column(u'allmychanges_changelog', 'status')

        # Deleting field 'Changelog.processing_status'
        db.delete_column(u'allmychanges_changelog', 'processing_status')
