...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'allmychanges_changelog', 'name', self.gf('django.db.models.fields.CharField')(default='unknown', max_length=80))

        # Changing field 'Changelog.namespace'
        db.alter_column(u'allmychanges_changelog', 'namespace', self.gf('django.db.models.fields.CharField')(default='unknown', max_length=80))
