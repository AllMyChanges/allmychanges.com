...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'EmailVerificationCode'
        db.create_table(u'allmychanges_emailverificationcode', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(related_name='email_verification_code', unique=True, to=orm['allmychanges.User'])),
            ('hash', self.gf('django.db.models.fields.CharField')(default='', max_length=32)),
            ('deployed_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'allmychanges', ['EmailVerificationCode'])


    def backwards(self, orm):
        # Deleting model 'EmailVerificationCode'
        db.delete_table(u'allmychanges_emailverificationcode')
