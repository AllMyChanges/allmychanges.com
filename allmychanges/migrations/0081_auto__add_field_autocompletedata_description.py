...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AutocompleteData.description'
        db.add_column(u'allmychanges_autocompletedata', 'description',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=1000),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AutocompleteData.description'
        db.delete_column(u'allmychanges_autocompletedata', 'description')
