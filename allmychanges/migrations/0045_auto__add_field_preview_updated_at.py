...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Preview.updated_at'
        db.add_column(u'allmychanges_preview', 'updated_at',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Preview.updated_at'
        db.delete_column(u'allmychanges_preview', 'updated_at')
