...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Changelog', fields ['namespace', 'name']
        db.create_unique(u'allmychanges_changelog', ['namespace', 'name'])


    def backwards(self, orm):
        # Removing unique constraint on 'Changelog', fields ['namespace', 'name']
        db.delete_unique(u'allmychanges_changelog', ['namespace', 'name'])
