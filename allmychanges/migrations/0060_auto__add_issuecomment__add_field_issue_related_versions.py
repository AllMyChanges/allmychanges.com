...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'allmychanges_issuecomment', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('issue', self.gf('django.db.models.fields.related.ForeignKey')(related_name='comments', to=orm['allmychanges.Issue'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='issue_comments', null=True, to=orm['allmychanges.User'])),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
            ('message', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal(u'allmychanges', ['IssueComment'])

        # Adding field 'Issue.related_versions'
        db.add_column(u'allmychanges_issue', 'related_versions',
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'allmychanges_issuecomment')

        # Deleting field 'Issue.related_versions'
        db.delete_column(u'allmychanges_issue', 'related_versions')
