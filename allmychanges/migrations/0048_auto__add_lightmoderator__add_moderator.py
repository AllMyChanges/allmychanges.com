...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'LightModerator'
        db.create_table(u'allmychanges_lightmoderator', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('changelog', self.gf('django.db.models.fields.related.ForeignKey')(related_name='light_moderators', to=orm['allmychanges.Changelog'])),
            ('light_user', self.gf('django.db.models.fields.CharField')(max_length=40)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'allmychanges', ['LightModerator'])

        # Adding model 'Moderator'
        db.create_table(u'allmychanges_moderator', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('changelog', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['allmychanges.Changelog'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['allmychanges.User'])),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('from_light_user', self.gf('django.db.models.fields.CharField')(max_length=40, null=True, blank=True)),
        ))
        db.send_create_signal(u'allmychanges', ['Moderator'])


    def backwards(self, orm):
        # Deleting model 'LightModerator'
        db.delete_table(u'allmychanges_lightmoderator')

        # Deleting model 'Moderator'
        db.delete_table(u'allmychanges_moderator')
