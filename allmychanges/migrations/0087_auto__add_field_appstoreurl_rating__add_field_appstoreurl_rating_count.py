...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AppStoreUrl.rating'
        db.add_column(u'allmychanges_appstoreurl', 'rating',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'AppStoreUrl.rating_count'
        db.add_column(u'allmychanges_appstoreurl', 'rating_count',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AppStoreUrl.rating'
        db.delete_column(u'allmychanges_appstoreurl', 'rating')

        # Deleting field 'AppStoreUrl.rating_count'
        db.delete_column(u'allmychanges_appstoreurl', 'rating_count')
