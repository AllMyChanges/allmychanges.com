...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'User.email_is_valid'
        db.add_column(u'allmychanges_user', 'email_is_valid',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'User.email_is_valid'
        db.delete_column(u'allmychanges_user', 'email_is_valid')
