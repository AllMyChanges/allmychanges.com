...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Changelog.check_list'
        db.add_column(u'allmychanges_changelog', 'check_list',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=1000),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Changelog.check_list'
        db.delete_column(u'allmychanges_changelog', 'check_list')
