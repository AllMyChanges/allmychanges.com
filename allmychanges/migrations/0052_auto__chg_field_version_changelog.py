...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Version.changelog'
        db.alter_column(u'allmychanges_version', 'changelog_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['allmychanges.Changelog']))

    def backwards(self, orm):

        # Changing field 'Version.changelog'
        db.alter_column(u'allmychanges_version', 'changelog_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['allmychanges.Changelog']))
