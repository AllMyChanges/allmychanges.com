...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Changelog.description'
        db.add_column(u'allmychanges_changelog', 'description',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Changelog.description'
        db.delete_column(u'allmychanges_changelog', 'description')
