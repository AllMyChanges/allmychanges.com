...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Package.problem'
        db.delete_column(u'allmychanges_package', 'problem')

        # Adding field 'Changelog.problem'
        db.add_column(u'allmychanges_changelog', 'problem',
                      self.gf('django.db.models.fields.CharField')(max_length=1000, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Package.problem'
        db.add_column(u'allmychanges_package', 'problem',
                      self.gf('django.db.models.fields.CharField')(max_length=1000, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Changelog.problem'
        db.delete_column(u'allmychanges_changelog', 'problem')
