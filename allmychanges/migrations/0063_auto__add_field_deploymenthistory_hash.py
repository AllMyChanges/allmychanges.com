...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DeploymentHistory.hash'
        db.add_column(u'allmychanges_deploymenthistory', 'hash',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=32),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DeploymentHistory.hash'
        db.delete_column(u'allmychanges_deploymenthistory', 'hash')
