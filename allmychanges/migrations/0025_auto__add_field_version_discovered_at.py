...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Version.discovered_at'
        db.add_column(u'allmychanges_version', 'discovered_at',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Version.discovered_at'
        db.delete_column(u'allmychanges_version', 'discovered_at')
