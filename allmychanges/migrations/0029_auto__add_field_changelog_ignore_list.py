...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Changelog.ignore_list'
        db.add_column(u'allmychanges_changelog', 'ignore_list',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=10000),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Changelog.ignore_list'
        db.delete_column(u'allmychanges_changelog', 'ignore_list')
    ...
    models = {
        u'allmychanges.changelog': {
            ...
            'ignore_list': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '10000'}),
