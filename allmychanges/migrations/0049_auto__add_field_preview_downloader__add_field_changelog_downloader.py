...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Preview.downloader'
        db.add_column(u'allmychanges_preview', 'downloader',
                      self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Changelog.downloader'
        db.add_column(u'allmychanges_changelog', 'downloader',
                      self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Preview.downloader'
        db.delete_column(u'allmychanges_preview', 'downloader')

        # Deleting field 'Changelog.downloader'
        db.delete_column(u'allmychanges_changelog', 'downloader')
