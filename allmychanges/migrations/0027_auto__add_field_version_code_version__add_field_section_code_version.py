...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Version.code_version'
        db.add_column(u'allmychanges_version', 'code_version',
                      self.gf('django.db.models.fields.CharField')(default='v1', max_length=255),
                      keep_default=False)

        # Adding field 'Section.code_version'
        db.add_column(u'allmychanges_section', 'code_version',
                      self.gf('django.db.models.fields.CharField')(default='v1', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Version.code_version'
        db.delete_column(u'allmychanges_version', 'code_version')

        # Deleting field 'Section.code_version'
        db.delete_column(u'allmychanges_section', 'code_version')
