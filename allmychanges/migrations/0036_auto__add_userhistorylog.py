...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'UserHistoryLog'
        db.create_table(u'allmychanges_userhistorylog', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='history_log', null=True, to=orm['allmychanges.User'])),
        ...
        db.send_create_signal(u'allmychanges', ['UserHistoryLog'])


    def backwards(self, orm):
        # Deleting model 'UserHistoryLog'
        db.delete_table(u'allmychanges_userhistorylog')
    ...
    models = {
        u'allmychanges.changelog': {
            ...
            'namespace': ('django.db.models.fields.CharField', [], {'max_length': '80', 'null': 'True'}),
