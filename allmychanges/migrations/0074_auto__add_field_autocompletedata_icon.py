...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AutocompleteData.icon'
        db.add_column(u'allmychanges_autocompletedata', 'icon',
                      self.gf('django.db.models.fields.CharField')(max_length=1000, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AutocompleteData.icon'
        db.delete_column(u'allmychanges_autocompletedata', 'icon')
