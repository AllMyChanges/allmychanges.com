...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Preview.downloader'
        db.alter_column(u'allmychanges_preview', 'downloader', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

    def backwards(self, orm):

        # Changing field 'Preview.downloader'
        db.alter_column(u'allmychanges_preview', 'downloader', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))
