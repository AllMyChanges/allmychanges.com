...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal(u'allmychanges', ['AutocompleteWord2'])

        # Adding M2M table for field data_objects on 'AutocompleteWord2'
        m2m_table_name = db.shorten_name(u'allmychanges_autocompleteword2_data_objects')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('autocompleteword2', models.ForeignKey(orm[u'allmychanges.autocompleteword2'], null=False)),
            ('autocompletedata', models.ForeignKey(orm[u'allmychanges.autocompletedata'], null=False))
        ))
        db.create_unique(m2m_table_name, ['autocompleteword2_id', 'autocompletedata_id'])

        # Adding index on 'AutocompleteWord', fields ['word']
        db.create_index(u'allmychanges_autocompleteword', ['word'])


    def backwards(self, orm):
        # Removing index on 'AutocompleteWord', fields ['word']
        db.delete_index(u'allmychanges_autocompleteword', ['word'])

        # Deleting model 'AutocompleteWord2'
        db.delete_table(u'allmychanges_autocompleteword2')

        # Removing M2M table for field data_objects on 'AutocompleteWord2'
        db.delete_table(db.shorten_name(u'allmychanges_autocompleteword2_data_objects'))
