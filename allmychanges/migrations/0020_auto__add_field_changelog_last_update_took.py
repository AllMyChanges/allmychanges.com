...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Changelog.last_update_took'
        db.add_column(u'allmychanges_changelog', 'last_update_took',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Changelog.last_update_took'
        db.delete_column(u'allmychanges_changelog', 'last_update_took')
