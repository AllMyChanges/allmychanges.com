...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ChangelogTrack'
        db.create_table(u'allmychanges_changelogtrack', (
        ...
        db.send_create_signal(u'allmychanges', ['ChangelogTrack'])


        # Changing field 'Changelog.created_at'
        db.alter_column(u'allmychanges_changelog', 'created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

    def backwards(self, orm):
        # Deleting model 'ChangelogTrack'
        db.delete_table(u'allmychanges_changelogtrack')


        # Changing field 'Changelog.created_at'
        db.alter_column(u'allmychanges_changelog', 'created_at', self.gf('django.db.models.fields.DateTimeField')())
    ...
    models = {
        ...
        u'allmychanges.user': {
            ...
            'changelogs': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['allmychanges.Changelog']", 'through': u"orm['allmychanges.ChangelogTrack']", 'symmetrical': 'False'}),
