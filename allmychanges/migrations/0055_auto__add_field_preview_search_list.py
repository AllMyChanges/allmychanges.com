...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Preview.search_list'
        db.add_column(u'allmychanges_preview', 'search_list',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=1000, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Preview.search_list'
        db.delete_column(u'allmychanges_preview', 'search_list')
