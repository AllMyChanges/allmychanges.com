...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'UserStateHistory'
        db.create_table(u'allmychanges_userstatehistory', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='state_history', to=orm['allmychanges.User'])),
            ('date', self.gf('django.db.models.fields.DateField')()),
            ('state', self.gf('django.db.models.fields.CharField')(max_length=40)),
        ))
        db.send_create_signal(u'allmychanges', ['UserStateHistory'])


    def backwards(self, orm):
        # Deleting model 'UserStateHistory'
        db.delete_table(u'allmychanges_userstatehistory')
