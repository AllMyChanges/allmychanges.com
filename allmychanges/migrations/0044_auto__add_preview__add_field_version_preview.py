...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'allmychanges_preview', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='previews', null=True, to=orm['allmychanges.User'])),
            ('changelog', self.gf('django.db.models.fields.related.ForeignKey')(related_name='previews', to=orm['allmychanges.Changelog'])),
            ('light_user', self.gf('django.db.models.fields.CharField')(max_length=40)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('ignore_list', self.gf('django.db.models.fields.CharField')(default='', max_length=1000, blank=True)),
            ('check_list', self.gf('django.db.models.fields.CharField')(default='', max_length=1000, blank=True)),
        ))
        db.send_create_signal(u'allmychanges', ['Preview'])

        # Adding field 'Version.preview'
        db.add_column(u'allmychanges_version', 'preview',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='versions', null=True, on_delete=models.SET_NULL, to=orm['allmychanges.Preview']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'Preview'
        db.delete_table(u'allmychanges_preview')

        # Deleting field 'Version.preview'
        db.delete_column(u'allmychanges_version', 'preview_id')
