...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DeploymentHistory'
        db.create_table(u'allmychanges_deploymenthistory', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('description', self.gf('django.db.models.fields.TextField')()),
            ('deployed_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'allmychanges', ['DeploymentHistory'])


    def backwards(self, orm):
        # Deleting model 'DeploymentHistory'
        db.delete_table(u'allmychanges_deploymenthistory')
