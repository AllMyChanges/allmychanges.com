...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AutocompleteData.score'
        db.add_column(u'allmychanges_autocompletedata', 'score',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AutocompleteData.score'
        db.delete_column(u'allmychanges_autocompletedata', 'score')
