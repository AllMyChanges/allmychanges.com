...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Changelog.job_timeout'
        db.add_column(u'allmychanges_changelog', 'job_timeout',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Changelog.job_timeout'
        db.delete_column(u'allmychanges_changelog', 'job_timeout')
    ...
    models = {
        u'allmychanges.changelog': {
            ...
            'job_timeout': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
