...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'User.send_digest'
        db.add_column(u'allmychanges_user', 'send_digest',
                      self.gf('django.db.models.fields.CharField')(default='daily', max_length=100),
                      keep_default=False)

        # Adding field 'User.slack_url'
        db.add_column(u'allmychanges_user', 'slack_url',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=2000),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'User.send_digest'
        db.delete_column(u'allmychanges_user', 'send_digest')

        # Deleting field 'User.slack_url'
        db.delete_column(u'allmychanges_user', 'slack_url')
    ...
    models = {
        ...
        u'allmychanges.user': {
            ...
            'slack_url': ('django.db.models.fields.URLField', [], {'default': "''", 'max_length': '2000'}),
