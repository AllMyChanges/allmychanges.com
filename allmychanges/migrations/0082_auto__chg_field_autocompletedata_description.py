...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'AutocompleteData.description'
        db.alter_column(u'allmychanges_autocompletedata', 'description', self.gf('django.db.models.fields.CharField')(max_length=255))

    def backwards(self, orm):

        # Changing field 'AutocompleteData.description'
        db.alter_column(u'allmychanges_autocompletedata', 'description', self.gf('django.db.models.fields.CharField')(max_length=1000))
