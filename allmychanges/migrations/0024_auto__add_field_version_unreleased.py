...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Version.unreleased'
        db.add_column(u'allmychanges_version', 'unreleased',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Version.unreleased'
        db.delete_column(u'allmychanges_version', 'unreleased')
