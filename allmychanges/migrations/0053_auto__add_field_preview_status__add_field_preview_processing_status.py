...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Preview.status'
        db.add_column(u'allmychanges_preview', 'status',
                      self.gf('django.db.models.fields.CharField')(default='created', max_length=40),
                      keep_default=False)

        # Adding field 'Preview.processing_status'
        db.add_column(u'allmychanges_preview', 'processing_status',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=40),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Preview.status'
        db.delete_column(u'allmychanges_preview', 'status')

        # Deleting field 'Preview.processing_status'
        db.delete_column(u'allmychanges_preview', 'processing_status')
