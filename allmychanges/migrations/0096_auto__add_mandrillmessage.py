...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'MandrillMessage'
        db.create_table(u'allmychanges_mandrillmessage', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('mid', self.gf('django.db.models.fields.CharField')(max_length=32, db_index=True)),
            ('timestamp', self.gf('django.db.models.fields.IntegerField')()),
            ('email', self.gf('django.db.models.fields.EmailField')(max_length=75)),
            ('payload', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal(u'allmychanges', ['MandrillMessage'])


    def backwards(self, orm):
        # Deleting model 'MandrillMessage'
        db.delete_table(u'allmychanges_mandrillmessage')
