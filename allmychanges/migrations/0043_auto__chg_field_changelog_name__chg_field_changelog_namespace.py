...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Changelog.name'
        db.alter_column(u'allmychanges_changelog', 'name', self.gf('django.db.models.fields.CharField')(max_length=80, null=True))

        # Changing field 'Changelog.namespace'
        db.alter_column(u'allmychanges_changelog', 'namespace', self.gf('django.db.models.fields.CharField')(max_length=80, null=True))

    def backwards(self, orm):

        # Changing field 'Changelog.name'
        db.alter_column(u'allmychanges_changelog', 'name', self.gf('django.db.models.fields.CharField')(default=None, max_length=80))

        # Changing field 'Changelog.namespace'
        db.alter_column(u'allmychanges_changelog', 'namespace', self.gf('django.db.models.fields.CharField')(default=None, max_length=80))
