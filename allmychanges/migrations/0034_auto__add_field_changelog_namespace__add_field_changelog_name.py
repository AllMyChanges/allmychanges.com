...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Changelog.namespace'
        db.add_column(u'allmychanges_changelog', 'namespace',
                      self.gf('django.db.models.fields.CharField')(max_length=80, null=True),
                      keep_default=False)

        # Adding field 'Changelog.name'
        db.add_column(u'allmychanges_changelog', 'name',
                      self.gf('django.db.models.fields.CharField')(max_length=80, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Changelog.namespace'
        db.delete_column(u'allmychanges_changelog', 'namespace')

        # Deleting field 'Changelog.name'
        db.delete_column(u'allmychanges_changelog', 'name')
