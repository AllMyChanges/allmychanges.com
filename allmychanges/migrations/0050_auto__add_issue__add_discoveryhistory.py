...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Issue'
        db.create_table(u'allmychanges_issue', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('changelog', self.gf('django.db.models.fields.related.ForeignKey')(related_name='issues', to=orm['allmychanges.Changelog'])),
        ...
        db.send_create_signal(u'allmychanges', ['Issue'])

        # Adding model 'DiscoveryHistory'
        db.create_table(u'allmychanges_discoveryhistory', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('changelog', self.gf('django.db.models.fields.related.ForeignKey')(related_name='discovery_history', to=orm['allmychanges.Changelog'])),
            ('discovered_versions', self.gf('django.db.models.fields.TextField')()),
            ('new_versions', self.gf('django.db.models.fields.TextField')()),
            ('num_discovered_versions', self.gf('django.db.models.fields.IntegerField')()),
            ('num_new_versions', self.gf('django.db.models.fields.IntegerField')()),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'allmychanges', ['DiscoveryHistory'])


    def backwards(self, orm):
        # Deleting model 'Issue'
        db.delete_table(u'allmychanges_issue')

        # Deleting model 'DiscoveryHistory'
        db.delete_table(u'allmychanges_discoveryhistory')
