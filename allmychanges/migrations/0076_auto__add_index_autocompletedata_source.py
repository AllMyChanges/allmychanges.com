...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        # Removing index on 'AutocompleteData', fields ['source']
        db.delete_index(u'allmychanges_autocompletedata', ['source'])
    ...
    models = {
        u'allmychanges.autocompletedata': {
            ...
            'source': ('django.db.models.fields.CharField', [], {'db_index': 'True', 'max_length': '1000', 'null': 'True', 'blank': 'True'}),
