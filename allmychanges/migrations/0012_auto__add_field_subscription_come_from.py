...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Subscription.come_from'
        db.add_column(u'allmychanges_subscription', 'come_from',
                      self.gf('django.db.models.fields.CharField')(default='old-homepage', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Subscription.come_from'
        db.delete_column(u'allmychanges_subscription', 'come_from')
