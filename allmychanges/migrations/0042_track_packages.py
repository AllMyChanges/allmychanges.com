...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        ChangelogTrack = orm['allmychanges.ChangelogTrack']
        for user in orm['allmychanges.User'].objects.all():
            for package in user.packages.all():
                ChangelogTrack.objects.create(user=user, changelog=package.changelog)
