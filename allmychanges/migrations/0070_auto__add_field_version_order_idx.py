...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Version.order_idx'
        db.add_column(u'allmychanges_version', 'order_idx',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Version.order_idx'
        db.delete_column(u'allmychanges_version', 'order_idx')
