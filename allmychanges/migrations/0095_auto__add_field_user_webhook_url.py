...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'User.webhook_url'
        db.add_column(u'allmychanges_user', 'webhook_url',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=2000, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'User.webhook_url'
        db.delete_column(u'allmychanges_user', 'webhook_url')
