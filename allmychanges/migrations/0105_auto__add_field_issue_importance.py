...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Issue.importance'
        db.add_column(u'allmychanges_issue', 'importance',
                      self.gf('django.db.models.fields.IntegerField')(default=0, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Issue.importance'
        db.delete_column(u'allmychanges_issue', 'importance')
    ...
    models = {
        ...
        u'allmychanges.issue': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'importance': ('django.db.models.fields.IntegerField', [], {'db_index': 'True'}),
