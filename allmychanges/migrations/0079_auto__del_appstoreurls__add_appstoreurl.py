...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'AppStoreUrls'
        db.delete_table(u'allmychanges_appstoreurls')

        # Adding model 'AppStoreUrl'
        db.create_table(u'allmychanges_appstoreurl', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('source', self.gf('django.db.models.fields.CharField')(max_length=255, unique=True, null=True, blank=True)),
            ('autocomplete_data', self.gf('django.db.models.fields.related.OneToOneField')(related_name='appstore_url', null=True, on_delete=models.SET_NULL, to=orm['allmychanges.AutocompleteData'], blank=True, unique=True)),
        ))
        db.send_create_signal(u'allmychanges', ['AppStoreUrl'])


    def backwards(self, orm):
        # Adding model 'AppStoreUrls'
        db.create_table(u'allmychanges_appstoreurls', (
            ('source', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255, null=True, blank=True)),
            ('autocomplete_data', self.gf('django.db.models.fields.related.OneToOneField')(related_name='appstore_url', null=True, on_delete=models.SET_NULL, to=orm['allmychanges.AutocompleteData'], blank=True, unique=True)),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal(u'allmychanges', ['AppStoreUrls'])

        # Deleting model 'AppStoreUrl'
        db.delete_table(u'allmychanges_appstoreurl')
