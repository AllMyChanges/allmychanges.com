...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Package', fields ['user', 'namespace', 'name']
        db.delete_unique(u'allmychanges_package', ['user_id', 'namespace', 'name'])
    ...
    def backwards(self, orm):
        ...
        db.create_table(u'allmychanges_repo', (
            ('processing_state', self.gf('django.db.models.fields.CharField')(max_length=20, null=True)),
            ('processing_status_message', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('processing_date_finished', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('url', self.gf('django.db.models.fields.URLField')(max_length=200, unique=True)),
            ('changelog_markup', self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True)),
            ('processing_date_started', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('processing_progress', self.gf('django.db.models.fields.PositiveIntegerField')(default=0)),
            ('date_created', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('requested_count', self.gf('django.db.models.fields.PositiveIntegerField')(default=0)),
        ))
        ...
        db.create_table(u'allmychanges_package', (
            ('repo', self.gf('django.db.models.fields.related.OneToOneField')(related_name='package', unique=True, null=True, to=orm['allmychanges.Repo'], blank=True)),
            ('source', self.gf('django.db.models.fields.CharField')(max_length=1000)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=80)),
            ('changelog', self.gf('django.db.models.fields.related.ForeignKey')(related_name='packages', null=True, to=orm['allmychanges.Changelog'], on_delete=models.SET_NULL, blank=True)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('namespace', self.gf('django.db.models.fields.CharField')(max_length=80)),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='packages', to=orm['allmychanges.User'])),
        ))
        db.send_create_signal(u'allmychanges', ['Package'])

        # Adding unique constraint on 'Package', fields ['user', 'namespace', 'name']
        db.create_unique(u'allmychanges_package', ['user_id', 'namespace', 'name'])
        ...
        db.create_table(u'allmychanges_section', (
            ...
            ('code_version', self.gf('django.db.models.fields.CharField')(max_length=255)),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
