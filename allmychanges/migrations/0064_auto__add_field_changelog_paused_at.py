...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Changelog.paused_at'
        db.add_column(u'allmychanges_changelog', 'paused_at',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Changelog.paused_at'
        db.delete_column(u'allmychanges_changelog', 'paused_at')
