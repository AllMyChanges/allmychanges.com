...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'allmychanges_user', 'timezone', self.gf('django.db.models.fields.CharField')(max_length=100))

    def backwards(self, orm):

        # Changing field 'User.timezone'
        db.alter_column(u'allmychanges_user', 'timezone', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))
