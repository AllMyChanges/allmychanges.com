...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Changelog.filename'
        db.add_column(u'allmychanges_changelog', 'filename',
                      self.gf('django.db.models.fields.CharField')(max_length=1000, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Changelog.filename'
        db.delete_column(u'allmychanges_changelog', 'filename')
