...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Issue.email'
        db.add_column(u'allmychanges_issue', 'email',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Issue.page'
        db.add_column(u'allmychanges_issue', 'page',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)


        # Changing field 'Issue.changelog'
        db.alter_column(u'allmychanges_issue', 'changelog_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['allmychanges.Changelog']))

    def backwards(self, orm):
        # Deleting field 'Issue.email'
        db.delete_column(u'allmychanges_issue', 'email')

        # Deleting field 'Issue.page'
        db.delete_column(u'allmychanges_issue', 'page')


        # Changing field 'Issue.changelog'
        db.alter_column(u'allmychanges_issue', 'changelog_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['allmychanges.Changelog']))
